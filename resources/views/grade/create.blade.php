...
@endforeach
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="pwd"  name="grade_group"  >
    </div>
   
    <div class="mb-3">
      <label for="grade_order">Grade Order</label>
      <input type="text" class="form-control" id="pwd"  name="grade_order"  >
    </div>

    <div class="mb-3">
      <label for="grade_color">Grade Color</label>
      <input type="text" class="form-control" id="pwd"  name="grade_color"  >
    </div>
